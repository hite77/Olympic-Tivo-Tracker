...
public class ParserTest {
    ...
    @Test
    public void canParseDescriptions() {
        String firstDescription = "With his father trapped in the wreckage of their spacecraft, a youth treks across Earth's now-hostile terrain to recover their rescue beacon and signal for help. Copyright Tribune Media Services, Inc.";
        String secondDescription = "When Homer and Marge enroll Bart in an activities club, he wages war against Milhouse, who belongs to a different one. Copyright Tribune Media Services, Inc.";
        parser parser = new parser();
        parser.parse(testData);
        ArrayList<Recording> recordings = parser.getRecordings();
